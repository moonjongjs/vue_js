            ...
            var blindW = win.innerWidth()/4;
                ...
                function resizeFn(){
                    winH = win.height();
                        ...
                        winW = win.innerWidth();
                        blindW = win.innerWidth()/4;
                        $('.slide>div>ul>li').eq(0).children().css({backgroundPosition:(-blindW*0) +'px 0px', backgroundSize: winW + 'px auto'});
                        $('.slide>div>ul>li').eq(1).children().css({backgroundPosition:(-blindW*1) +'px 0px', backgroundSize: winW + 'px auto'});
                        $('.slide>div>ul>li').eq(2).children().css({backgroundPosition:(-blindW*2) +'px 0px', backgroundSize: winW + 'px auto'});
                        $('.slide>div>ul>li').eq(3).children().css({backgroundPosition:(-blindW*3) +'px 0px', backgroundSize: winW + 'px auto'});
                        
                        slide.eq(cnt).css({zIndex:3}).find('li').stop().animate({width:0},0).animate({width:25+'%'},0);
                ...
                function pageBtnEventFn(){
                    var setId3 = 0;
                    var lenCnt = 0;
                    $('.pageBtn').css({width:0,backgroundColor:'transparent'});
                   ...
                   setId3 = setInterval(function(){
                        ...
                        if(lenCnt>150){                            
                            ...
                            $('.pageBtn').css({width:0,backgroundColor:'transparent'});
                            $('.pageBtn').eq(cnt).css({width:lenCnt,backgroundColor:'#fff'}); 
                        }
