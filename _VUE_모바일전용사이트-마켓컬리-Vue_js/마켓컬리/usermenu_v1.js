...
Vue.component('user-menu-pc', {
    props:['loginCheck', 'notificationItem', 'userInfo'],
    template:'\
    <ul class="list_menu">\
        ...
        <li class="menu none_sub" v-if="!loginCheck">\
            <a href="/shop/member/login.php" class="link_menu">로그인</a>\
        </li>\
        <li class="menu menu_user" v-if="loginCheck">\
            <a href="/shop/mypage/mypage_orderlist.php" class="link_menu grade_comm">\
            ...
            <ul class="sub">\
                ...
                <li>\
                    <a href="/shop/member/logout.php">로그아웃</a>\
                </li>\
            </ul>\
        </li>\
        <li class="menu">\
